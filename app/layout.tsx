  ...
  return (
    <html lang="en">
      <head>
        ...
        <Script id="gtm" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-KCK4CDJG');
          `}
        </Script>

        {/* Google tag (gtag.js) - Google Ads */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=AW-948149620"
      ...
      <body>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KCK4CDJG"
            height="0"
            width="0"
